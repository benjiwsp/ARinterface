...
/*
 * this class is to read the words from the image for digital clock
 */
public class Words {
	...
	public void draw(float[] projection, float[] view, float[] model,
			ShaderHandles Shader, int textures) {
		...
		GLES20.glVertexAttribPointer(Shader.mTextureCoordinateHandle, 2,
				GLES20.GL_FLOAT, false, 2 * 4, texBuffer);

		// send uniforms
		GLES20.glUniformMatrix4fv(Shader.projectionHandle, 1, false,
				projection, 0);
