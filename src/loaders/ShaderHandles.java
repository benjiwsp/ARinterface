...
public class ShaderHandles {
	...
	public int positionHandle, normalHandle, mTextureCoordinateHandle,
			modelHandle, viewHandle, projectionHandle, isColored, colorHandle,
			lightHandle, viewPointHandle, tangentHandle, mvHandle;
